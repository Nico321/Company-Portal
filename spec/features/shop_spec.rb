...
let!(:bserver) {FactoryGirl.create(:article, name: "Big Server", description: "This Server is really awesome and will fulfil all your needs. From medium to big sized companies. Try it out!", price: 8999.99, delivertime: 10, image: File.open("#{Rails.root}/spec/support/fixtures/bigserver.jpg"))}
...
let!(:computer){FactoryGirl.create(:article, name: "Computer", description: "Just a standard PC for everyday needs. Watching porn or whatever!", price: 599.99, delivertime: 2, image: File.open("#{Rails.root}/spec/support/fixtures/computer.jpg"))}
