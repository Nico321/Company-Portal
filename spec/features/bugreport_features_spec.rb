...
describe "Bugreports"  do 
	before :each do
		login
		cu = User.last
		Bugreport.create(:subject => "testtest", :description => "testtest", :reporter_id => cu.id)
		Bugreport.create(:subject => "testtest", :description => "testtest",:reporter_id => cu.id , :agent_id => cu.id)
		Bugreport.create(:subject => "testtest", :description => "testtest",:reporter_id => cu.id , :agent_id => cu.id, :closed => Time.now)
